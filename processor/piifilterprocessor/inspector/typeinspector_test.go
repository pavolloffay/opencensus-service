...
func Test_typeinspector_int(t *testing.T) {
	...
	inspector.inspect(message, "test.key", 32)
...
func Test_typeinspector_float(t *testing.T) {
	...
	inspector.inspect(message, "test.key", 32.1)
...
func Test_typeinspector_bool(t *testing.T) {
	...
	inspector.inspect(message, "test.key", true)
...
func Test_typeinspector_char(t *testing.T) {
	...
	inspector.inspect(message, "test.key", 'a')
...
func Test_typeinspector_string(t *testing.T) {
	...
	inspector.inspect(message, "test.key", "value")
